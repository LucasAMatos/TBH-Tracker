...
> **Recorte atual:** até **v10.0** (segundo arquivamento; v6–v10). O arquivamento da v10 estava adiado e foi concluído agora. Itens entregues em v11+ permanecem no `BACKLOG.md` até o próximo corte (v15).
