...
- **Fase 4 — Qualidade de vida:** 🚧 alertas (✅ baús acumulando — B2 v0.5.0, por tipo; pendente: level-up, novo estágio), **dashboard customizável** (✅ v1.1.0 / U10 — widgets liga/desliga + colapsáveis, layout persistido), gráficos de sessão, i18n PT/EN.
