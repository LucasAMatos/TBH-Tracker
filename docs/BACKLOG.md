...
- **C2 (P2):** ✅ v3.0 — Alertas de marcos do Cubo (níveis 4/5/8/10; ex.: nível 10 = Trade Ship liberado). Card mostra próximo desbloqueio + seção "Marcos do Cubo" com estado e quanto falta.

### Baús (P1/P2) — `BoxData.BoxQuantity`
- **B1 (P1):** ✅ v1.0 — Contagem de baús não abertos.
- **B2 (P2):** ✅ v5.0 — Baús por categoria (Comum/Estágio/Ato; soma de `BoxQuantity` agrupada por `BoxTypes`) + alerta de **acúmulo** (não há teto fixo no jogo; limiares calibráveis na UI, persistidos localmente).
