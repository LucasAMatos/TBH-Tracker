...
| `itemSaveDatas[]` (`ItemKey,UniqueId,...`) | Itens/inventário | Drops novos por corrida; ✅ D5 (v1.9.0): derretimento (ouro+XP de Cubo) via `DB.itemSell`/`itemCubeExp` (`meltData.ts`), excluindo equipados/Legendary+ |
